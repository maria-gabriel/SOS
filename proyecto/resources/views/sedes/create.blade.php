...
@section('content')
  {!! Form::open(array('route' => array('sedes.store', $sede),'method'=>'post','class'=>'container')) !!}
<br>
<div class="container">
    ...
    <div class="col-7 mt-2">
        {!! Form::label('','Sede') !!}
        {!! Form::text('nombre',$sede->nombre,array('class' => 'form-control form-gray px-2', 'placeholder'=>'Nombre', 'required'))!!}
    </div>
    <br>
