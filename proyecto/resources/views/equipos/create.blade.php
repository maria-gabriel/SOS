...
@section('content')
  {!! Form::open(array('route' => array('equipos.store', $equipo),'method'=>'post','class'=>'container')) !!}
<br>
<div class="container">
    ...
    <div class="col-7 mt-2">
        {!! Form::label('','Equipo') !!}
        {!! Form::text('equipo',$equipo->equipo,array('class' => 'form-control form-gray px-2', 'placeholder'=>'Nombre', 'required'))!!}
    </div>
    <br>
