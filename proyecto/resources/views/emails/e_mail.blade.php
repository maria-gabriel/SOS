...
<html>
  ...
  <body style="font-family: sans-serif;">
    <div style="display: block; margin: auto; max-width: 600px;" class="main">
      <h1 style="font-size: 18px; font-weight: bold; margin-top: 20px">Nueva solicitud de conferencia</h1>
      <p>Una nueva solicitud de videoconferencia ha sido generada.</p>
