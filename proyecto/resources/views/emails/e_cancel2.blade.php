...
<html>
  ...
  <body style="font-family: sans-serif;">
    <div style="display: block; margin: auto; max-width: 600px;" class="main">
      <h1 style="font-size: 18px; font-weight: bold; margin-top: 20px">Solicitud de videoconferencia no autorizada</h1>
      ...
      <ul style="padding-left: 10px;">
        ...
        <li><b>Motivo de cancelación:</b> {{$detalles->comentario}}</li>
      </ul>
