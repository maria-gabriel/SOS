...
/*JS ORDENES DE SERVICIO Y VIDEOCONFERENCIAS 2022*/

//Change Select2 Direccion -> Subdireccion -> Departamento
$("#cat_dir").on('change',function(){ 
  ...
  //Change Custom color/mode/size SOS
   function bgcolor(a){
    var color = a.getAttribute("data-color");
    document.getElementById("custom").value = color;
    $("#toSend").trigger("click");
  }

  function modcolor(){
    var mode = body.classList.contains('dark-version');
    if(mode){
      document.getElementById("custom2").value = 'light-version';
    }else{
      document.getElementById("custom2").value = 'dark-version';
    }
    $("#toSend").trigger("click");
  }

  function menucolor(a){
    var menu = a.getAttribute("data-class");
    document.getElementById("custom3").value = menu;
    $("#toSend").trigger("click");
  }

  $('#limite').on('change', function() {
    var dias = document.getElementById("limite").value;
    document.getElementById("custom4").value = dias;
    $("#toSend").trigger("click");
});

  //Filter Datatable SOS
  $('#estado').change(function(){
        $('#table_filter input').val($(this).val());
